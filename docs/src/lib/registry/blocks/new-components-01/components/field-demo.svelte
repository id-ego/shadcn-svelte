	...
	<form>
		<Field.Group>
			<Field.Set>
				...
				<Field.Group>
					<Field.Field>
						<Field.Label for="checkout-7j9-card-name-43j">카드 소유자명</Field.Label>
						<Input id="checkout-7j9-card-name-43j" placeholder="홍길동" required />
					</Field.Field>
					<Field.Field>
						<Field.Label for="checkout-7j9-card-number-uw1">카드 번호</Field.Label>
						<Input
							id="checkout-7j9-card-number-uw1"
							placeholder="1234 5678 9012 3456"
							required
						/>
						<Field.Description>16자리 카드 번호를 입력하세요</Field.Description>
					</Field.Field>
					<div class="grid grid-cols-3 gap-4">
						<Field.Field>
							<Field.Label for="checkout-exp-month-ts6">월</Field.Label>
			...
			<Field.Set>
				<Field.Group>
					<Field.Field>
						<Field.Label for="checkout-7j9-optional-comments">의견</Field.Label>
						<Textarea
